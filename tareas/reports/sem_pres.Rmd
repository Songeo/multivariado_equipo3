...
corel <- lav_matrix_lower2full(c(1, .54, 1, -.35, -.29, 1, -.37, -.28, .67,
                                 1, -.36, -.3, .56, .44, 1, -.41, -.29, .47, .52, .66, 1))
#colnames(corel) <- row.names(corel) <- c('Educ', 'SEI', 'Anomia71', 'Powles71', #'Anomia67', 'Powles67')

alienation_model <- specifyModel("../data/modalin.txt")
...
knitr::include_graphics("../doc/pathdiagram.png")
```
